...
def get_villains():
  ...
  for villain in villains:
    data.append({"name":villain.name, "description":villain.description, "interests":villain.interests, "url":villain.url, "date_added":villain.date_added})
...
def get_endpoints():
  endpoints = {
    ...
    "/api/villains/delete": "POST - Removes the villain from the database",
    "/api/villain/add": "POST - Adds the villain to the database"
  }
